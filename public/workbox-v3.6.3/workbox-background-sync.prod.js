this.workbox = this.workbox || {}, this.workbox.backgroundSync = function (e, t) {
    ...
    const i = "workbox-background-sync", n = "requests", u = "queueName", c = "workbox-background-sync", o = 10080;

    class l {
        constructor(t) {
            this.t = t, this.r = new e.DBWrapper(i, 1, {onupgradeneeded: e => e.target.result.createObjectStore(n, {autoIncrement: !0}).createIndex(u, u, {unique: !1})})
        }
    ...
    class h {
        ...
        replayRequests() {
            var e = this;
            return babelHelpers.asyncToGenerator(function* () {
                const r = Date.now(), s = [], i = [];
                let n;
                for (; n = yield e.u.getAndRemoveOldestEntry();) {
                    const t = n.clone(), u = 60 * e.n * 1e3;
