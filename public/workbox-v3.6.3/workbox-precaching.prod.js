this.workbox = this.workbox || {}, this.workbox.precaching = function (e, t, n, r, s) {
    ...
    class i {
        ...
        i(e) {
            ...
            if ("cache" in Request.prototype) n.cache = "reload"; else {
                const e = new URL(t, location), n = encodeURIComponent;
    ...
    const c = "revision", o = "url", l = "precached-details-models";
    ...
    const u = (d = babelHelpers.asyncToGenerator(function* (e) {
        const t = e.clone(), n = yield"body" in t ? Promise.resolve(t.body) : t.blob();
    ...
    class h {
        ...
        m({precacheEntry: e, event: t, plugins: n}) {
            var i = this;
            return babelHelpers.asyncToGenerator(function* () {
                let c = yield r.fetchWrapper.fetch({request: e.s, event: t, fetchOptions: null, plugins: n});
    ...
    let f = !1, y = !1, b = !1, w = [];
    const g = t.cacheNames.getPrecacheName(), v = new h(g),
        m = (e, {ignoreUrlParametersMatching: t = [/^utm_/], directoryIndex: n = "index.html", cleanUrls: r = !0, urlManipulation: s = null} = {}) => {
